...
{
    switch (type) {
    case simon::Fsm::StateType::INITIAL_STATE:
        return F("InitialState");
    case simon::Fsm::StateType::GAME_START_STATE:
        return F("GameStartState");
    case simon::Fsm::StateType::PLAYING_SEQUENCE_STATE:
        return F("PlayingSequenceState");
    case simon::Fsm::StateType::PLAYING_USER_STATE:
        return F("PlayingUserState");
    case simon::Fsm::StateType::PLAYING_WIN_STATE:
        return F("PlayingWinState");
    case simon::Fsm::StateType::PLAYING_LOSE_STATE:
        return F("PlayingLoseState");
    default:
        return F("UnknownState");
    }
}
...
{
    switch (type) {
    case simon::Fsm::EventType::GAME_START_EVENT:
        return F("GameStart");
    case simon::Fsm::EventType::PLAYING_SEQUENCE_EVENT:
        return F("PlayingSequence");
    case simon::Fsm::EventType::PLAYING_USER_EVENT:
        return F("PlayingUser");
    case simon::Fsm::EventType::PLAYING_WIN_EVENT:
        return F("PlayingWin");
    case simon::Fsm::EventType::PLAYING_LOSE_EVENT:
        return F("PlayingLose");
    default:
        return F("UnknownEvent");
    }
}

void simon::Fsm::setEnterCallback(CallbackEnterFunction cb)
{
    enter_cb = cb;
}

void simon::Fsm::setExitCallback(CallbackExitFunction cb)
{
    exit_cb = cb;
}
...
void simon::Fsm::Switch::reset()
{
    ...
    ::tinyfsm::StateList<InitialState, GameStartState, PlayingSequenceState, PlayingUserState, PlayingWinState, PlayingLoseState>::reset();
}
